...
def collate_fn(examples):
    ...
    tok_labels = torch.tensor([tokenizer.convertLabel2Id(label) for label in labels])
...
train_dataloader = DataLoader(split_dataset['train'], batch_size=16, collate_fn=collate_fn, num_workers=24)
valid_dataloader = DataLoader(split_dataset['valid'], batch_size=16, collate_fn=collate_fn, num_workers=24)
test_dataloader = DataLoader(split_dataset['test'], batch_size=16, collate_fn=test_collate_fn, num_workers=24)